...
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:grass"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name: '{"text":"oddish.gcode"}'}}}]} run data modify entity @e[type=minecraft:glow_item_frame, distance=0, limit=1] Item set value {id:"minecraft:grass", tag:{CustomModelData:1, display:{Name:'{"text":"Oddish"}'}}, Count:1b}
