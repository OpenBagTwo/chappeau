...
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:grass"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name:'"oddish.gcode"'}}}]} run data modify entity @e[type=minecraft:glow_item_frame, distance=0, limit=1] Item set value {id:"minecraft:grass", tag:{CustomModelData:1, display:{Name:'{"text":"Oddish"}'}}, Count:1b}
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:grass"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name:'"oddish.gcode"'}}}]} run data modify block ~ ~1 ~ Items[{Slot:0b}] merge value {Count:0b} 
