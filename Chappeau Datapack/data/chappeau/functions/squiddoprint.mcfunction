...
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:carved_pumpkin"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name:'"vulcan.gcode"'}}}]} run data modify entity @e[type=minecraft:glow_item_frame, distance=0, limit=1] Item set value {id:"minecraft:carved_pumpkin", tag:{CustomModelData:1702, display:{Name:'{"text":"Vulcan Ears"}'}}, Count:1b}
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:carved_pumpkin"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name:'"vulcan.gcode"'}}}]} run data modify block ~ ~1 ~ Items[{Slot:0b}] merge value {Count:0b}
...
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:compass"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name:'"tr580.gcode"'}}}]} run data modify entity @e[type=minecraft:glow_item_frame, distance=0, limit=1] Item set value {id:"minecraft:compass", tag:{CustomModelData:1701, display:{Name:'{"text":"Tricorder"}'}}, Count:1b}
execute if block ~ ~1 ~ minecraft:hopper{Items:[{Slot:0b, id:"minecraft:compass"}, {Slot:1b, id:"minecraft:paper", tag:{display: {Name:'"tr580.gcode"'}}}]} run data modify block ~ ~1 ~ Items[{Slot:0b}] merge value {Count:0b}
